  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="relative max-w-4xl mx-auto px-6 pt-28 pb-20 md:pt-36 md:pb-28 text-center">
          <h1 className="text-3xl md:text-5xl lg:text-[3.5rem] font-semibold tracking-tight leading-[1.08] mb-6 animate-fade-in-up">
            为产品照片<br />
